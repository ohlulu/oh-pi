...
How to write technical plan documents with clear decisions and rationale.
...
Unit tests are written **before** implementation (TDD). The testing strategy defines
_what_ to test and _how_; the task breakdown enforces _when_ (test-first per phase).
...
Before planning, read actual code in affected areas:
- Entry points and module structure
- Existing patterns and conventions
- Dependencies and interfaces

Never plan in a vacuum. The codebase is the ground truth of current state.
...
for one plan document — consider splitting.
...
- [ ] Every requirements scenario addressable by this plan
...
- [ ] No hand-waving ("implement as needed" is not a plan)
